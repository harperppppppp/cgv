...
| archive | 관람 기록 분석/관리 | 관람 기록·통계 확인 | mouse hover하면 섹션 늘어남 |
| foryou (ticket) | 굿즈 사전예약 홍보 | 예약하기 | 기본, 비활성(마감 시) |
| foryou (carousel) | 개인화 추천작 탐색 | 좌우 이동, 예매하기 | 기본, 로딩 |
| cinetalk | 리뷰 탐색 | 좌우 스크롤, 리뷰 더보기, 예매하기 | 기본 |
| coming | 상영예정작 탐색 | 영화 선택 | 기본 |
| icecon | ICECON 작품 탐색 | 마우스로 잡아서 원 돌리기, 예매하기 | 기본 |
